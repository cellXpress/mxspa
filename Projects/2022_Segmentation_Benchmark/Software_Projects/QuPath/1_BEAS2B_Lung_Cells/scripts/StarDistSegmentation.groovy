...
def stardist = StarDist2D.builder(pathModel)
        ...
        .channels('DNA')             // Select detection channel
        .normalizePercentiles(1, 99.99) // Percentile normalization
        ...
        .measureShape()              // Add shape measurements (Needed to do the filtering)
...
def toDelete = getCellObjects().findAll{
    measurement(it, 'Cell: Area px^2') < 2000  ||
    measurement(it, 'Cell: Area px^2') > 20000 ||
